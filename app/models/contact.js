  ...
  numbers: {
    ...
    validators: [
      validator('collection', {
        ...
        for: 'every',
        test(numObj) {
          return validateNumber(get(numObj, 'number'));
        },
      }),
...
export default DS.Model.extend(
  ...
  Validations,
  {
    ...
    isArchived: equal('status', Constants.CONTACT.STATUS.ARCHIVED),
    isBlocked: equal('status', Constants.CONTACT.STATUS.BLOCKED),
    isActive: equal('status', Constants.CONTACT.STATUS.ACTIVE),
    isUnread: equal('status', Constants.CONTACT.STATUS.UNREAD),
    intStatus: computed('status', function() {
