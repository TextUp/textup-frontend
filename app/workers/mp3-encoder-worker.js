...
function addToResults(data) {
  if (data.length > 0) {
    ...
    resultArrays.push(new Int8Array(data)); // eslint-disable-line
  }
}
...
function float32ToInt16Array(floatData) {
  const input = new Float32Array(floatData), // eslint-disable-line
    output = new Int16Array(floatData.length); // eslint-disable-line
